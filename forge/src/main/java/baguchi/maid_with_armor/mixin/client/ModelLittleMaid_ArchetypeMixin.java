...
@Mixin(ModelLittleMaid_Archetype.class)
public class ModelLittleMaid_ArchetypeMixin extends ModelLittleMaidBase implements IMaidArmor {
    public ModelLittleMaid_ArchetypeMixin() {
    }

    public ModelLittleMaid_ArchetypeMixin(float psize) {
        super(psize);
    }

    public ModelLittleMaid_ArchetypeMixin(float psize, float pyoffset, int pTextureWidth, int pTextureHeight) {
