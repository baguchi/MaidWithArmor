...
@Mixin(ModelLittleMaid_Elsa5.class)
public class ModelLittleMaid_ElsaMixin extends ModelLittleMaidBase implements IMaidArmor {
    public ModelLittleMaid_ElsaMixin() {
    }

    public ModelLittleMaid_ElsaMixin(float psize) {
        super(psize);
    }

    public ModelLittleMaid_ElsaMixin(float psize, float pyoffset, int pTextureWidth, int pTextureHeight) {
