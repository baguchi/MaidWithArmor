...
@Mixin(ModelLittleMaid_Orign.class)
public class ModelLittleMaid_OrignMixin extends ModelLittleMaidBase implements IMaidArmor {
    public ModelLittleMaid_OrignMixin() {
    }

    public ModelLittleMaid_OrignMixin(float psize) {
        super(psize);
    }

    public ModelLittleMaid_OrignMixin(float psize, float pyoffset, int pTextureWidth, int pTextureHeight) {
